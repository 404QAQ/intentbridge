...
![项目聊天亮色模式](../docs/screenshots/project-chat-light.png)
*亮色模式下的项目聊天界面*

![项目聊天暗色模式](../docs/screenshots/project-chat-dark.png)
*暗色模式下的项目聊天界面*

![聊天界面](../docs/screenshots/chat-interface.png)
*聊天消息和输入区域*

![状态面板](../docs/screenshots/status-panel.png)
*执行状态面板*

### 演示模式

无需 Claude API key 即可工作：
- 模拟 AI 响应
- 完整功能测试
- 无外部依赖
...
详细文档请参阅[项目聊天功能](../docs/PROJECT_CHAT_FEATURE.md)。
